<div class="row padding-1 p-1">
    <div class="col-md-12">
        <div class="form-group mb-2 mb20">
            ...
            <select id="sous_categorie_recette_id" class="form-control select2" name="sous_categorie_recette_id">
                <option value="{{ $natureRecetteCommunale->sous_categorie_recette_id }}">{{$natureRecetteCommunale->sousCategorieRecette->nom}}</option>
