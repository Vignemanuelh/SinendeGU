...
return [
    ...
    */
    ...
    | Cela permet de spécifier rapidement une ligne de langue personnalisée pour une
    | règle d'attribut donnée.
    |
    */
    ...
    | espace réservé d'attribut avec quelque chose de plus convivial comme
